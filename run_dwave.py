...
RESULT_FOLDER = "simdata_dwave"
ORDER_DIRNAME = 'orders_dwave'
CONFIG_DIRNAME = 'configs'

TAKE = ['order_8_3_a.txt']
...
def run(order_filename, config):
    ...
    for sol_heuristic_da in sols_heuristic_da:
        ...
        res_dict['qapres_dwave']= qapres_heuristic_da
        res_dict['res_dwave']= res_heuristic_da
        timing_list = t_heuristic_da['overall'] + t_heuristic_da['partition'][loop_index]
        res_dict['time_dwave']= timing_list
